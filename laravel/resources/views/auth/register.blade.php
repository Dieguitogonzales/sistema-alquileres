            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="fecha_de_nacimiento" class="col-md-4 col-form-label text-md-end">{{ __('Fecha de Nacimiento') }}</label>
                            <div class="col-md-6">
                                <input id="fecha_de_nacimiento" type="date" class="form-control @error('fecha_de_nacimiento') is-invalid @enderror" name="fecha_de_nacimiento" value="{{ old('fecha_de_nacimiento') }}" required>
                        ...
                        {{-- **BOTÓN "MODIFICAR" AÑADIDO AQUÍ** --}}
                        <div class="row mb-0 mt-2">
                            <div class="col-md-6 offset-md-4">
                                <a href="{{ route('tu.ruta.de.modificacion') }}" class="btn btn-primary">
                                    {{ __('Modificar') }}
                                </a>
                            </div>
                        </div>
