        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Alquileres</h4>
                    <a href="{{ route('admin.alquileres.create') }}" class="btn btn-primary float-right">Nuevo
                        Alquiler</a>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    <form action="{{ route('admin.alquileres.index') }}" method="GET" class="mb-3">
                        <div class="input-group">
                            <input type="text" class="form-control" name="buscado" placeholder="Buscar..."
                                value="{{ $buscado ?? '' }}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.alquileres.destroy', $alquiler->id) }}" method="POST"
                                        class="d-inline"
                            ...
                            @empty
                            <tr>
                                <td colspan="8">No se encontraron alquileres.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
